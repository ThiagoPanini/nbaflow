...
if save:
    gamelog.to_csv(os.path.join(os.getcwd(), 'dev/data/backup/one_player_gamelog.csv'), index=False)
...
try:
    ...
    logger.error(f'Falha na verificação da variável de ambiente "MAIL_TO" utilizada para definição de destinatários. Exception: {ae}')
