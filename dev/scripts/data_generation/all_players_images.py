...
from nbaflow.images import get_players_images
import os
import pandas as pd
...
TEMPLATE_IMG_PATH = os.path.join(PROJECT_PATH, 'dev/data/images/unknown.png')
GAMELOG_PATH = os.path.join(PROJECT_PATH, 'dev/data/all_players_gamelog.csv')
IMGS_PATH = os.path.join(PROJECT_PATH, 'dev/data/images/players/')
